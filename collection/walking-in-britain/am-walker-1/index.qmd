...
![Finger Post Points the Way](/img/finger_pointer.png){.column-margin fig-alt="A finger post sign pointing to trails in multiple directioins"}
...
![More comfortable than camping?](/img/canopy_bed.png){.column-margin fig-alt="Hotel room with large canopy bed"}
