...
attempts to estimate VO2 Max.The [Wikipedia](https://en.wikipedia.org/wiki/VO2_max)
article on VO2 Max describes a number of different methods for estimating
VO2 Max. What does Apple do? Who knows. That's the kind of thing that Apple
keeps close to the vest. As with resting heart rate, let's
