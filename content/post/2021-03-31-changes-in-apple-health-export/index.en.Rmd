...
measurement of blood pressure. The protocol for collecting data as
...
So the national norms for heart rate are based on sitting quietly for at least
3 minutes and then a physician takes your pulse. That procedure leads to 
articles such as [Relation of Higher Resting Heart Rate to Risk of Cardiovascular Versus Noncardiovascular Death](https://pubmed.ncbi.nlm.nih.gov/28132682/)  
...
by NHANES seem like the horse and buggy days. There may be hundreds of
...
but in it is not so clear what it means in practice. I am going
to dive deep into my own data to try to observe what is actually happening with
...
The key is "not while you're asleep" combined with the fact that Apple didn't
...
of the Apple Health Export. For each data row in the export their is a start date
...
One might expect additional changes in the future. It seems likely that
Apple's determination of when one is asleep may be improved, i.e., changed,
over time. That might directly affect the measurement of resting heart
rate.

### VO2 Max

[VO2 Max](https://en.wikipedia.org/wiki/VO2_max) is the rate of oxygen
consumption during heavy exercise. Direct measures involve exercising
...
They may not be willing to describe the operational definition
of the summary measurements they provide. Here we have looked at
