...
Web scraping with [rvest](https://github.com/hadley/rvest) and [SelectorGadget](https://selectorgadget.com) can be powerful and fun. Recently I was experimenting
...
In my case, javascript is adding html after the original page was sent to the browser. (Or at least I think that is what is going on.)
...
Installed it on my Windows computer at work via a [PhantomJS install page](http://phantomjs.org/download.html). I also installed it on my Mac at home
