...
date: 2021-05-09
subtitle: Odds and Ends of Things I Have Found
...
![](img/ggridges_example.png) [geofacet](https://hafen.github.io/geofacet/)
...
scio palettes: <https://github.com/thomasp85/scico> ![](img/scico_palette_show.png)
...
markdown code for figure: (html parameters within curly braces) ![(Text, italic in ())](/img/hugo_pool/page_inspector.jpg){width="100%"}
