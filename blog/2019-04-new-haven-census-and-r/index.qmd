...
author: John Goldin
date: '2019-04-11'
description: 'Using the tidycensus package to explore census data. This post shows R code to fetch and map census data, but also gives some tips on how to explore the almost overwhelmind variety of variables available via the Census Bureau.'
categories:
  - census
  - maps
  - R
...
image-alt: "a figure decorating the Yale Law School that represents sanctimony"
aliases:
