...
description: "Summary of Connecticut Covid-19 based on Department of Public Health Data with some comparisons to national data. This has been updated each weekday during 2020 and most of 2021. There are also notes on sources of data for Covid-19 in Connecticut."
# output: 
#   blogdown::html_page:
...
```
<link href="{{< blogdown/postref >}}index.en_files/jquery-sparkline/jquery.sparkline.css"
rel="stylesheet" /\>
...
```
::: {#vprynqcgbh style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;"}
...
Nursing home cases<sup class="gt_footnote_marks">1</sup>
...
Source: Multiple tables from
<a href="https://data.ct.gov/stories/s/COVID-19-data/wa3g-tfvc/">Connecticut
Open Data</a>
...
Nursing home data are reported only weekly so the dates for "today" and
a "week ago" are 06/19/2020 and 06/11/2020. <br />
...
::: figure
}}index.en_files/figure-html/p-new-cases-1.png" alt="New Cases"
width="672" /\>
...
::: figure
}}index.en_files/figure-html/p-rt-live-1.png" alt="Estimated
R\<sub\>t\</sub\>" width="672" /\>
...
::: figure
}}index.en_files/figure-html/p-daily-deaths-1.png" alt="Daily Deaths"
width="672" /\>
...
::: figure
}}index.en_files/figure-html/p-hospitalizations-1.png" alt="Covid-19
Patients in Hospital" width="672" /\>
...
R<sub>t</sub> is less than 1, it is decreasing. See the site [covidestim
· COVID-19 nowcasting](https://covidestim.org) for an estimate by state
of the effective value for R<sub>t</sub>. The site is described in [this
...
R<sub>t</sub> well under 1. As of 05/16/2021 R<sub>t</sub> is 0.77. On
the other hand, in Arizona R<sub>t</sub> is about 0.91.
...
::: figure
}}index.en_files/figure-html/p-rt-map-1.png" alt="Estimate of
R\<sub\>t\</sub\> by State" width="95%" /\>
...
::: figure
}}index.en_files/figure-html/p-states-map-1.png" alt="New Cases per 100K
by State" width="95%" /\>
...
::: figure
}}index.en_files/figure-html/deaths-by-age2-1.png" alt="Covid-19 Deaths
by Age" width="672" /\>
...
::: figure
}}index.en_files/figure-html/deaths-per-100k2-1.png" alt="Covid-19 Cases
by Age" width="672" /\>
...
been 2,719 deaths in Connecticut Nursing Homes which makes 33.3% of the
total of 8,173 deaths from Covid-19.
...
As of 05/14/2021, 4,469 inmates have tested positive for Covid-19. At
the peak of the epidemic, 158 inmates were isolated at the Northern
Correctional Institution medical facility. The most recent report is
that 19 died, and currently NA Covid-19 inmates remain in that medical
facility.
...
1,670 staff have tested positive for Covid-19, of whom 1,649 have been
...
<a href="#fig:county-maps">9</a> shows the cumulative total of cases
since the start of the epidemic. The second map shows only new cases
reporting during the last two weeks. On both maps, cases are adjusted to
show cases per 100K of population. So the first map relates more to the
total impact of the disease over the full course of the epidemic to
date, and the second map is an indication of the recent prevalence of
the virus.
...
::: figure
}}index.en_files/figure-html/county-maps-1.png" alt="County Maps of New
and of Cumulative Cases" width="50%"
/\>}}index.en_files/figure-html/county-maps-2.png" alt="County Maps of
New and of Cumulative Cases" width="50%" /\>
...
::: figure
}}index.en_files/figure-html/county-by-category-1.png" alt="Cases by
County" width="672" /\>
...
maximum height shown on the scale is 100 while for deaths, the maximum
value shown is 23.7. For both new cases and deaths, the sparkline shows
the rolling seven day average of new cases or deaths.
