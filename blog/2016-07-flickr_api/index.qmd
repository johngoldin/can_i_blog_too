...
aliases:
    - /2016/06/flickr_api/
description: 'Detailed description of how to access the Flickr API via R. I would do it somewhat differently in 2021.'
image: featured-example.png
image-alt: 'a screenshot showing an example of an image attaching to a spot on the map'
categories:
  - R
  - Flickr
  - Leaflet
...
<img style="float: right;" src="/img/Hadrians-Wall-screenshot.png", height="301", width="252"\>To see where all this is leading, go to my Shiny app which displays [souvenirs of my walks](https://goldin.shinyapps.io/Walks/). Click on a camera icon and you will see a thumbnail photo from Flickr in a popup. Click on the popup, and you will be taken to the full-sized photo in Flickr. To the right is a screenshot of the app showing a popup photo of Hadrian's Wall. The GPS traces are in orange and red (for two different days).
...
I used these calls to add photo markers a Leaflet map showing souvenirs of my walking holidays. You can see the results [here](https://goldin.shinyapps.io/Walks/).
