...
# quarto render blog/2022-07-02-trump-vote-and-vaccination
date: '2022-09-02'
categories:
  - COVID19
tags:
  - COVID19
editor: visual
slug: trump-vote-ct-covid
description: |
  National county-level data shows a correlation between COVID vaccination
...
The plot in Figure @fig-age and the analyses done by Charles Gaba investigate individual vaccination behavior by looking at aggregate entities. That can be tricky.

See this summary based on the the [Marquette University Law School Poll](https://www.marquette.edu/news-center/2021/new-marquette-law-poll-finds-majority-of-republicans-favor-a-trump-run-for-president-in-2024.php).
