...
if (1 == 2) {
  ...
  update_ukr_mod_df("ukr_mod_df.RData", save_fname_ukr_mod_df = "ukr_mod_df.RData", days_previous = 10) |> print()
}
...
milestones <- tibble(
  date = c("2022-04-19","2022-05-08", "2022-05-13", "2022-05-20", 
           ...
           "2023-02-13", "2023-06-06", "2023-10-10", "2024-02-17") |> ymd(),
