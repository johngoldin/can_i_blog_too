...
if (1 == 2) {
  ...
  update_ukr_mod_df("ukr_mod_df.RData", save_fname_ukr_mod_df = "ukr_mod_df.RData", days_previous = 8) |> print()
}
...
milestones <- tibble(
  ...
  event = c("Russian attack in east","Siverskyi Russian failure", "UKR counter-attack Kharkiv", "Mariupol Fell",
            ...
            "Vuhledar offensive", "Nova Kakhovka dam", "Avdiivka offensive", "Fall of Adviika", "Russia attacks Kharkiv area"),
  short_event = c("Attack","Siverskyi", "Kharkiv", "Mariupol", 
                  "Lymann", "Kherson", "Lysychansk", "Kharkiv", 
                  "Kharkiv", "mobilized", "cleared west", "Bakhmut",
                  "Vuhledar", "dam", "Avdiivka", "Adviivka Lost", "Kharkiv")
) |> arrange(date)
