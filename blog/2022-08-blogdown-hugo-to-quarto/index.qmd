...
[Albert Rapp](https://albert-rapp.de/posts/13_quarto_blog_writing_guide/13_quarto_blog_writing_guide.html) has a lot of concrete information about setting up a Quarto blog, but also how to do some custumizations. He has some very specific suggestion on use the renv package to [preserve the package environment](https://albert-rapp.de/posts/13_quarto_blog_writing_guide/13_quarto_blog_writing_guide.html#make-posts-robust-with-renv) for each blog post.
