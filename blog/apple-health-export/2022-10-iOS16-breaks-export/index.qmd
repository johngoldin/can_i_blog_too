---
title: "iOS 16 Breaks Apple Health Export"
editor: visual
author: John Goldin
date: '2022-10-20'
...
tags:
  - Apple-Health-Export
description: |
  Version 16 of iOS breaks the Apple Health Export. The export no longer
  produces a valid XML file. That's the case at least through
  version 16.0.3. This post describes a work-around provided by
  user etresoft on the Apple Support forum that repairs the
  exported XML file so that it can be imported.
layout: single
format:
  html:
    code-fold: true
...
I've now used this fix a couple of times without problem, most recently with version 16.0.3 of iOS. I'm not optimistic that Apple is going to fix this problem any time soon. I've attempted to file a bug report with Apple.
