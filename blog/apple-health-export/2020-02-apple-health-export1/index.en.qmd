...
```{r tbl-count-clin-record-types, echo = FALSE, eval = FALSE}
# The count by type is in @tbl-count-clin-record-types).
...
```{r fig-hist-by-time, echo = FALSE, fig.cap = "Density Plot by Time of Observation"}
