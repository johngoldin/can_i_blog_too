---
# quarto render blog/2016-06-28-technical-note-shiny-souvenir-map
title: Technical Note--Shiny Souvenir Map of Walks
date: '2016-06-28'
slug: "walks_map_notes"
aliases:
    - /2016/06/walks_map_notes/
description: 'Note on the creation of a [map](https://goldin.shinyapps.io/Walks/) created using Shiny which shows GPS traces and photos of my walking holidays.'
image: featured-souvenir-map.png
image-alt: 'a screenshot of the souvenir map described in this post'
categories:
  - Leaflet
  - GPS
  - Flickr
...
See this post for code examples on [how to access Flickr from R](blog/2016-07-flickr-api/).
